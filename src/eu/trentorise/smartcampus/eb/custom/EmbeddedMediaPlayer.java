...
public class EmbeddedMediaPlayer implements OnCompletionListener,
		SeekBar.OnSeekBarChangeListener, ResourceHandler {
	...
	public EmbeddedMediaPlayer(ViewGroup parent, String fileUri) {
		...
		mc = ((LayoutInflater) parent.getContext().getSystemService(
				Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.media_ctrl,
				null);
	...
	private void playFile() {
		try {
			...
			if (Utils.isRemote(fileUri)) {
				mc.getContext().startActivity(
						new Intent(Intent.ACTION_VIEW, Uri.parse(fileUri)));
			}
		}
	}
	...
	public void onStartTrackingTouch(SeekBar arg0) {
		try {
			...
			int currentPosition = progressToTimer(arg0.getProgress(),
					totalDuration);
